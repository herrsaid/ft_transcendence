...
if (!data)
{
  return <div className="py-8 w-[350px] mx-auto">
  <div className="bg-gradient-to-br from-purple-600 to-indigo-800 rounded-lg shadow-md p-6 flex items-center space-x-4 transform transition-transform hover:scale-105">
    ...
    <div className="flex flex-col flex-1 space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="text-purple-400 text-sm">Games: 0</div>
        <div className="text-green-400 text-sm">Wins: 0</div>
        <div className="text-yellow-400 text-sm">Losses: 0</div>
      </div>
      <div className="text-blue-400 text-xl">Win Rate: You Dont have Any Game Yet!</div>
    </div>
...
const winRate = (data.totalwins / data.totalgames) * 100;
  ...
  <div className="bg-gradient-to-br from-purple-600 to-indigo-800 rounded-lg shadow-md p-6 flex items-center space-x-4 transform transition-transform hover:scale-105">
    ...
    <div className="flex flex-col flex-1 space-y-2">
      ...
      <div className="flex items-center justify-between">
        <div className="text-purple-400 text-sm">Games: {data.totalgames}</div>
        <div className="text-green-400 text-sm">Wins: {data.totalwins}</div>
        <div className="text-yellow-400 text-sm">Losses: {data.totalosses}</div>
      </div>
      <div className="text-blue-400 text-xl">Win Rate: {winRate}%</div>
    </div>
