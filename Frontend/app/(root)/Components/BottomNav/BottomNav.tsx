...
export default function BottomNav()
{
    return(
        <>
        <nav className="fixed bottom-2 lg:bottom-2 w-full overflow-hidden z-50">
            <div className="container mx-auto">
                <div className="w-full h-[96px] bg-black/20 backdrop-blur rounded-full max-w-[460px] mx-auto 
